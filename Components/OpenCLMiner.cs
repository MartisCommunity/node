...
namespace XOuranos.X1.Components
{
    ...
    public class OpenCLMiner : IDisposable
    {
        ...
        private void GetOpenCLSources()
        {
            ...
            {
                Node.Resource.SpartacryptOpenCLMiner_opencl_device_info_h,
                Node.Resource.SpartacryptOpenCLMiner_opencl_misc_h,
                Node.Resource.SpartacryptOpenCLMiner_opencl_sha2_common_h,
                Node.Resource.SpartacryptOpenCLMiner_opencl_sha512_h,
                Node.Resource.SpartacryptOpenCLMiner_sha512_miner_cl
            };
        }
