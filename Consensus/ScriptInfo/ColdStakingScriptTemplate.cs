...
using static XOuranos.Consensus.ScriptInfo.OpcodeType;

namespace XOuranos.Consensus.ScriptInfo
{
    /// <summary>
    ...
    public class ColdStakingScriptTemplate : ScriptTemplate
    {
        ...
        /// transaction. If this flag is set then further rules are enforced by <see cref="XOuranos.Features.Consensus.Rules.CommonRules.PosColdStakingRule"/>.
        /// </remarks>
