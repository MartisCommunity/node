...
using XOuranos.Features.Diagnostic.Controllers.Models;
using XOuranos.Features.Diagnostic.PeerDiagnostic;
using XOuranos.Features.Diagnostic.Utils;
using XOuranos.P2P.Peer;
using XOuranos.Utilities.JsonErrors;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;

namespace XOuranos.Features.Diagnostic.Controllers
{
    /// <summary>
