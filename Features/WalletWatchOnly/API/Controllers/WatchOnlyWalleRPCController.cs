...
using XOuranos.Features.WalletWatchOnly.Api.Models;
using XOuranos.Features.WalletWatchOnly.Interfaces;
...
namespace XOuranos.Features.WalletWatchOnly.Api.Controllers
{
    /// <summary>
