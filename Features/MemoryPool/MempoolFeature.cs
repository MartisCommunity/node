...
using XOuranos.Features.MemoryPool.Fee;
using XOuranos.Features.MemoryPool.FeeFilter;
...
[assembly: InternalsVisibleTo("XOuranos.Features.MemoryPool.Tests")]

namespace XOuranos.Features.MemoryPool
{
    /// <summary>
