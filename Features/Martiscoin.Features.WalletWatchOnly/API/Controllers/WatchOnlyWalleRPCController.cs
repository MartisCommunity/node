...
using Martiscoin.Features.WalletWatchOnly.Api.Models;
using Martiscoin.Features.WalletWatchOnly.Interfaces;
...
namespace Martiscoin.Features.WalletWatchOnly.Api.Controllers
{
    /// <summary>
