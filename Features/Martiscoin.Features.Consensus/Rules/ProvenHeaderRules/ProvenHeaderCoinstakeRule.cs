...
namespace Martiscoin.Features.Consensus.Rules.ProvenHeaderRules
{
    /// <summary>
    ...
    /// <seealso cref="T:Martiscoin.Features.Consensus.Rules.ProvenHeaderRules.ProvenHeaderRuleBase" />
