...
using Martiscoin.Features.ColdStaking.Api.Controllers;
using Martiscoin.Features.ColdStaking.Api.Models;
...
[assembly: InternalsVisibleTo("Martiscoin.Features.ColdStaking.Tests")]
