...
namespace XOuranos.Features.NodeHost
{
                ...
                .UseKestrel(options =>
                    {
                        ...
                        var ipAddresses =System.Net.Dns.GetHostAddresses(apiSettings.ApiUri.DnsSafeHost);
    ...
    internal class EditorRCLConfigureOptions : IPostConfigureOptions<StaticFileOptions>
    {
        ...
        public void PostConfigure(string name, StaticFileOptions options)
        {
            ...
            //var list = ass.GetFiles();
            var filesProvider = new EmbeddedFileProvider(ass);
            //var files = filesProvider.GetDirectoryContents("/Features/");
