...
using XOuranos.Features.NodeHost.Hubs;
...
using XOuranos.Features.NodeHost.Authorization;
using XOuranos.Features.NodeHost.Settings;
using Microsoft.AspNetCore.Mvc.Authorization;
using System.Text.Json.Serialization;

namespace XOuranos.Features.NodeHost
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<XOuranosSettings>(this.Configuration.GetSection("XOuranos"));
            ...
            if (hostSettings.EnableAPI)
            {
                ...
                options =>
                {
                    ...
                    string description = "Access to the XOuranos Node features.";
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (hostSettings.EnableAPI)
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    ...
                    {
                        c.RoutePrefix = "docs";
                        c.SwaggerEndpoint("/docs/node/openapi.json", "XOuranos Node API");
                    });
                });
            }
        }
