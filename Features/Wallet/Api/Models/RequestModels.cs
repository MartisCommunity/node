...
using System.Linq;
using XOuranos.Features.Wallet.Validations;
using XOuranos.Utilities.ValidationAttributes;
...
namespace XOuranos.Features.Wallet.Api.Models
{
    ...
    public class WalletRecoveryRequest : RequestModel
    {
        ...
        /// <summary>
        /// Optional CoinType to overwrite the default <see cref="XOuranos.Consensus.IConsensus.CoinType"/>.
        /// </summary>
