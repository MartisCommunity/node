...
using System.Linq;
using Martiscoin.Features.Wallet.Validations;
using Martiscoin.Utilities.ValidationAttributes;
...
namespace Martiscoin.Features.Wallet.Api.Models
{
    ...
    public class WalletRecoveryRequest : RequestModel
    {
        ...
        /// <summary>
        /// Optional CoinType to overwrite the default <see cref="Martiscoin.Consensus.IConsensus.CoinType"/>.
        /// </summary>
